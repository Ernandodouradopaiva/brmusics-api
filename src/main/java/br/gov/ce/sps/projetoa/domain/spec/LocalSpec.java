...
public final class LocalSpec {

    private LocalSpec() {
    }

    public static Specification<Local> usandoFiltro(LocalFilter filtro) {
        return (root, query, builder) -> {
            ...
            if (StringUtils.hasText(filtro.getCidade())) {
                ...
                predicates.add(builder.like(builder.lower(root.get("cidade")), "%" + termo + "%"));
            }
